	...
	<div class="container" >
		...
		<div id="menu" >
			...
			<a href="loja" id="linkhome">Home</a>  <a href="loja?action=categorias"
				id="linkLogin" style="margin-left: 310px">Catálogo</a> <a href="sobre.jsp" id="linkquem" style="margin-left: 530px">Sobre o sistema </a> <a href="administracao" id="linkass"
				style="margin-left: 790px">Administração </a> <img
				src="loja/menupng/menu4.png" id="img" width="1020">
		</div>
